...
public class Carrinho implements Serializable {
	...
	public Pedido finalizarPedido() throws JAXBException {
	...
	private void atualizarQuantidadeDisponivelDoItemCompra(final ItemEstoque itemEstoque) {
		ItemCompra item = Iterables.find(this.itensDeCompra, new Predicate<ItemCompra>() {
			...
			public boolean apply(ItemCompra item) {
				return item.temCodigo(itemEstoque.getCodigo()); //http://localhost:8080/fj36-webservice/EstoqueWS
			}
		});
...
////			}
////			
////			ItemEstoque itemEstoque = estoqueRmi.getItemsEstoque(itemCompra.getCodigo());
////			verificarDisponibilidadeDosItensComRmi
...
//	}
	...
	public void verificarDisponibilidadeDosItensComSoap() throws Exception {
		...
		List<ItemEstoque> itensEstoque = resposta.getItemEstoque();
